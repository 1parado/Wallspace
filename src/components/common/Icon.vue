...
/** lucide 风格 24x24 线性图标 */
const PATHS: Record<string, string> = {
  compass:
    '<circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36z"/>',
  sparkles:
    '<path d="M9.94 15.5a2 2 0 0 0-1.44-1.44l-6.13-1.58a.5.5 0 0 1 0-.96l6.13-1.59a2 2 0 0 0 1.44-1.43l1.58-6.13a.5.5 0 0 1 .96 0l1.59 6.13a2 2 0 0 0 1.43 1.44l6.13 1.58a.5.5 0 0 1 0 .96l-6.13 1.59a2 2 0 0 0-1.44 1.43l-1.58 6.13a.5.5 0 0 1-.96 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/>',
  shuffle:
