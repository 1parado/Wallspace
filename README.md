...
- **导出为…** — 预览内一键裁剪导出：头像 1:1 / 社交竖图 4:5 / 手机 9:16 / 桌面 16:9 / 平板 4:3 预设，cover 模式支持拖拽取景、fit 模式完整显示；可加入媒体库或「另存为…」到任意位置
...
- **平台预设扩展** — 头像（GitHub / Bilibili / 微博 / 抖音…）与 Cover（GitHub Profile / B站主页 / 微博封面…）的尺寸与圆形蒙版预览，按平台提供上传规格说明
- **平台 API 直传**（需用户授权）：
